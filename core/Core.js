            ...
            try {
              ...
              if (contentType.startsWith("multipart/form-data")) {
                try {
                  ...
                  // Forward error to be handled by the catch block below
                  throw err;
                }
              ...
              if (
                ...
                err.message === "No boundary found in Content-Type" ||
                err.message ===
                  "Invalid Content-Type or missing headers for multipart"
              ) {
                res.statusCode = 400;
                res.end(err.message);
                return;
